...
function check(options) {
    ...
    if (typeof options.resumeKey !== "undefined" &&
        typeof options.resumeKey !== "string")
        throw new TypeError('Node option "resumeKey" must be a non-empty string.');
    if (typeof options.resumeTimeout !== "undefined" &&
        typeof options.resumeTimeout !== "number")
...
class Node {
    ...
    open() {
        ...
        this.socket.send(JSON.stringify({
            ...
            "timeout": !this.options.resumeTimeout ? 60 : this.options.resumeTimeout
        }));
    }
    close(code, reason) {
